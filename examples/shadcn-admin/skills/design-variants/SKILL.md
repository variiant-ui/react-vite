...
- `Cmd/Ctrl + Alt + ArrowUp` selects the previous mounted component
- `Cmd/Ctrl + Alt + ArrowDown` selects the next mounted component
...
- the proving app lives in `examples/shadcn-admin`
- the proving app's exploratory variants live in `examples/shadcn-admin/.variants`
